...
if ( ! function_exists( 'mp_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function mp_posted_by() {
		$byline = sprintf(
...
if ( ! function_exists( 'mp_entry_footer' ) ) :
	...
	function mp_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			/* translators: used between list items, there is a space after the comma */
			$tags_list = get_the_tag_list( '', esc_html_x( ', ', 'list item separator', 'mp' ) );
			if ( $tags_list ) {
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'mp' ),
						array(
							'span' => array(
								'class' => array(),
							),
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'mp' ),
					array(
						'span' => array(
							'class' => array(),
						),
