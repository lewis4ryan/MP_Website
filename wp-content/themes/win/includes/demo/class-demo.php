...
if ( ! class_exists( 'Winsome_Demo' ) ) {
	...
	class Winsome_Demo {
		...
		/**
		 * Singleton instance of Winsome_Demo.
		 *
		 * @var Winsome_Demo $instance Winsome_Demo instance.
		 */
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Winsome_Demo ) ) {
				self::$instance = new Winsome_Demo();
